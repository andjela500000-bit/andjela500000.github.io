...
const projectsData = {
    "fashion-blog": {
        ...
        time: "1 day",
        description: "A simple design for a fashion blog",
        skills: ["HTML", "CSS"],
    ...
    "travel-site": {
        title: "Travel Site",
        time: "2 days",
        description: "Simple site made for a travel agency",
        skills: ["HTML", "CSS"],
    ...
    "bakery-app": {
        ...
        time: "2 days",
        description: "Website mockup for mobile phones for showcasing all the products of a pastry shop",
        skills: ["Figma"],
    ...
    "weather-tracker": {
        ...
        time: "2 days",
        description: "App mockup for a weather app, primarily made for mobile phones",
        skills: ["Figma"],
    ...
    "food-for-thought": {
        ...
        time: "1 day",
        description: "Informative website about fun and interesting facts of all kinds",
    ...
    "know-your-parrots": {
        ...
        time: "2 days",
        description: "Informative website about parrots, with some articles that are SEO optimized",
